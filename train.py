...
from models import siamese, trident
# import helpers
...
def model_loader(model_name):
    ...
    if model_name == 'siamese' or model_name == 'siam':
        model = siamese.Siamese(num_classes=num_classes,  input_shape=(None, 256, 512, 3))
    elif model_name == 'trident' or model_name == 'tridentNet':
        model = trident.Trident(num_classes=num_classes,  input_shape=(None, 256, 512, 3))
    return model
